...
#commands.getoutput('export GST_PLUGIN_PATH=$%s' % (os.path.join(G.DIRECTORIO_BASE,"lib")))
...
class JAMediaVideo(gtk.Window):
    ...
    def __init__(self):
        ...
        self.set_icon_from_file(os.path.join(G.ICONOS, "JAMediaVideo.png"))
