...
class JAMedia_Efecto_bin(gst.Bin):
    ...
    def __init__(self, efecto):
        ...
        videoconvert = gst.element_factory_make("ffmpegcolorspace",
            "videoconvert_%s" % (efecto))

        efecto = gst.element_factory_make(efecto, efecto)
        ...
        self.add_pad(gst.GhostPad("src", efecto.get_static_pad("src")))
...
class JAMedia_Camara_bin(gst.Bin):
    ...
    def __init__(self):
        ...
        self.camara = gst.element_factory_make("v4l2src", "v4l2src")
...
class Theoraenc_bin(gst.Bin):
    ...
    def __init__(self):
        ...
        que_encode_video = gst.element_factory_make(
...
class Foto_bin(gst.Bin):
    ...
    def __init__(self):
        ...
        videoconvert = gst.element_factory_make(
            "ffmpegcolorspace", "videoconvert_gdkpixbuf")

        queue = gst.element_factory_make("queue", "queue_foto")
...
class Efectos_Video_bin(gst.Bin):
    ...
    def __init__(self, efectos, config_efectos):
        ...
        self.add_pad(gst.GhostPad("src", videoconvert.get_static_pad("src")))
...
class Audio_Visualizador_bin(gst.Bin):
    ...
    def __init__(self, visualizador):
        ...
        efecto = gst.element_factory_make(
            self.visualizador,
            self.visualizador)
...
class Pantalla_Bin (gst.Bin):
    ...
    def __init__(self):
        ...
        self.multi_out_tee = gst.element_factory_make(
            'tee', "multi_out_tee")
        self.multi_out_tee.set_property('pull-mode', 1)

        self.pantalla = gst.element_factory_make(
            'xvimagesink', "pantalla")

        #self.gdkpixbufsink = gst.element_factory_make(
        #    "gdkpixbufsink", "gdkpixbufsink")
...
class JAMedia_Audio_Pipeline (gst.Pipeline):
    ...
    def __init__(self):
        ...
        self.tee_audio = gst.element_factory_make(
            "tee", "tee_audio")
