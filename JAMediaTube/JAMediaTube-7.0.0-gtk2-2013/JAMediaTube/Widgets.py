...
class Toolbar_Busqueda(gtk.Toolbar):
    ...
    def __init__(self):
        ...
        label.modify_fg(0, get_color("BLANCO"))
        label.show()
        item.add(label)
        self.insert(item, -1)
...
class Toolbar_Descarga(gtk.VBox):
    ...
    def __init__(self):
        ...
        self.toolbar.modify_bg(0, get_color("NEGRO"))
        self.toolbar.modify_fg(0, get_color("BLANCO"))
        ...
        self.label_titulo.modify_fg(0, get_color("BLANCO"))
        ...
        self.label_progreso.modify_fg(0, get_color("BLANCO"))
...
class ProgressBar(gtk.HScale):
    ...
    def expose(self, widget, event):
        ...
        self.window.draw_rectangle(gc, True, rect.x, rect.x,
