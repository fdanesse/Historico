...
class JAMediaPlayer(gtk.Plug):
    ...
    def set_layout(self):
        ...
        self.volumen.jamediamixer.set_position(
    ...
    def set_menu_list(self, widget, item, boton, pos, tiempo):
        ...
        if item.tipo == "Audio_Video":
            ...
            #Plectura, Pescritura, Pejecucion =
            #   self.origenes_de_datos.verificar_permisos(item.url)
    ...
    def set_accion_archivos(self, item, accion):
        ...
        if accion == "Borrar":
            ...
            '''
                ...
                dialog = StandarDialog(self, "Mensaje JAMedia",
                    _("¿ Confirmas que Deseas Mover el Archivo ?"))
                response = dialog.run()
                dialog.destroy()
                if response == gtk.RESPONSE_YES:
